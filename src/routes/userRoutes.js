...
router.get('/login/register-edit', userController.edit);
...
router.get("/create", validations, userController.crearusuario)
router.post("/create", validations, userController.procesoUsuario)

//Sup.Admin - EDITAR usuario
router.get("/editar", validations, userController.editar)
